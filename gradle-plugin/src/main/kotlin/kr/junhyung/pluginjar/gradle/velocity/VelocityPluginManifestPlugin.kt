...
abstract class VelocityPluginManifestPlugin : Plugin<Project> {

    override fun apply(project: Project) {
        project.plugins.withType<JavaPlugin> {
            val extension = project.extensions.create<VelocityPluginExtension>("velocityPlugin")
            ...
            val manifestDir = GenerateVelocityPluginJson.register(project, extension)
